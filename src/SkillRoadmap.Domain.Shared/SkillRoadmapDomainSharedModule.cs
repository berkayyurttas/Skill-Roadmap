...
public class SkillRoadmapDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        SkillRoadmapGlobalFeatureConfigurator.Configure();
        SkillRoadmapModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<SkillRoadmapDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<SkillRoadmapResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/SkillRoadmap");

            options.DefaultResourceType = typeof(SkillRoadmapResource);
        ...
        {
            options.MapCodeNamespace("SkillRoadmap", typeof(SkillRoadmapResource));
        });
    }
}
