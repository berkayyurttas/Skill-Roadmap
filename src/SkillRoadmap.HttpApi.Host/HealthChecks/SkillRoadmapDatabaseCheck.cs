...
public class SkillRoadmapDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public SkillRoadmapDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
