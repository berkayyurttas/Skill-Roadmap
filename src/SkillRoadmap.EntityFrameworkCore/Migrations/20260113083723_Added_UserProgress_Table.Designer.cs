...
namespace SkillRoadmap.Migrations
{
    ...
    [Migration("20260113083723_Added_UserProgress_Table")]
    partial class Added_UserProgress_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkillRoadmap.Roadmaps.Roadmap", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppRoadmaps", (string)null);
                });

            modelBuilder.Entity("SkillRoadmap.Roadmaps.RoadmapStep", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppRoadmapSteps", (string)null);
                });

            modelBuilder.Entity("SkillRoadmap.Roadmaps.UserProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SkillRoadmap.Roadmaps.RoadmapStep", b =>
                {
                    b.HasOne("SkillRoadmap.Roadmaps.Roadmap", null)
                        .WithMany("Steps")
